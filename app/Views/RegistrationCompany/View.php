        ...
        <div style="min-height: 1100px" class="section-one">
            <div class="container-employee bg-employee position-relative">
                <div class="bg-white form-employee me-3 rounded">
                    ...
                    <form action="/signupCompany" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <div class="row p-3">
                            ...
                            <span class="mb-2">
                                ...
                                <br>
                                <span style="color: rgb(0,91,182)">Already have an account ?
                                    <a href="/login_company" class="text-decoration-none fw-bold">Sign in</a>
                                </span>
                            </span>
                            <div class="col-6 mt-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= session()->getFlashdata('namaBisnis') ? 'is-invalid' : '' ?>" id="namaBisnis" name="namaBisnis" value="<?= old('namaBisnis') ?? '' ?>">
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= session()->getFlashdata('namaBisnis') ?? '' ?>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="noHp" class="form-label">Nomor HP</label>
                                    <input type="text" class="form-control <?= session()->getFlashdata('noHp') ? 'is-invalid' : '' ?>" id="noHp" name="noHp" value="<?= old('noHp') ?? '' ?>">
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= session()->getFlashdata('noHp') ?? '' ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mt-2">
                                <div class="form-floating">
                                    <textarea class="form-control <?= session()->getFlashdata('alamatBisnis') ? 'is-invalid' : '' ?>" placeholder="Leave a comment here" id="alamatBisnis" name="alamatBisnis" style="height: 100px"><?= old('alamatBisnis') ?? '' ?></textarea>
                                    <label for="alamatBisnis">Alamat Bisnis</label>
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= session()->getFlashdata('alamatBisnis') ?? '' ?>
                                    </div>
                                </div>
                                <div class="mb-3 mt-1">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="inputGroupFile01">Logo Perusahaan</label>
                                    <input type="file" class="form-control <?= session()->getFlashdata('logoPerusahaan') ? 'is-invalid' : '' ?>" name="logoPerusahaan" id="inputGroupFile01">
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        <?= session()->getFlashdata('logoPerusahaan') ?? '' ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center mb-3">
                            <button style="background-color: rgb(230,2,120)" type="submit" class="btn btn-primary mb-1 border-0">Daftar</button>
                        </div>
                    </form>
                </div>
            </div>
